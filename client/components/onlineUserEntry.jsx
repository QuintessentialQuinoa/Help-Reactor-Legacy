...
class OnlineUserEntry extends React.Component {
  ...
  render () {
    ...
    if (((this.props.caller && this.props.caller.id === this.props.user.id) || this.props.appUser.role === 'mentor' || (this.props.appUser.role === 'student' && this.props.user.role === 'student')) && (this.props.user.id !== this.props.appUser.id.toString())) {
