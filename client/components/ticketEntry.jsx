    ...
    return (
      <div className={`ticket_list_entry alert ${className} clearfix`}>
        <div className="ticket_list_entry_meta clearfix">
          <div className="ticket_list_entry_name">{this.props.ticket.user.firstName} {this.props.ticket.user.lastName} ({this.props.ticket.location}, {this.props.ticket.user.ticketsPerDay} tickets/day avg) </div>
